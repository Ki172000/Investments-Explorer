      ...
      {activeTab === 'ingestion' && (
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '25px' }}>
          <div>
            ...
            <p style={{ fontSize: '0.88rem', color: '#555' }}>Drop raw copy-pasted text from notices into the processor box below:</p>
            <textarea
              value={inputText}
          ...
          <div>
            ...
            {!activeExtraction ? (
              ...
              <div style={{ background: '#fff', padding: '20px', borderRadius: '4px', border: '1px solid #ddd' }}>
                ...
                <h5 style={{ margin: '15px 0 8px 0', fontSize: '0.9rem', color: '#555' }}>Double-Entry Lines (Geneva GL Mapping)</h5>
